...
class OpenProjectService:
    ...
    async def process_webhook_json(self, body_json: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        if action == "work_package:created":
            ...
            activity_user_href = body_json["activity"]["_links"]["user"]
